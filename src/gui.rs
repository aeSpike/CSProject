...
pub fn main_menu(gs : &mut State, ctx : &mut Rltk) -> MainMenuResult {
    ...
    ctx.print_color_centered(15, RGB::named(rltk::YELLOW), RGB::named(rltk::BLACK), "My very cool game");
...
pub fn game_over(ctx : &mut Rltk) -> GameOverResult {
    ...
    ctx.print_color_centered(17, RGB::named(rltk::WHITE), RGB::named(rltk::BLACK), "Very sad");
    ctx.print_color_centered(18, RGB::named(rltk::WHITE), RGB::named(rltk::BLACK), "So so sad");
